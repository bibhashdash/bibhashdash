...
export const AboutDrawer = ({onClickClose, isOpen}: AboutDrawerProps) => {
  ...
  return (
    <div className="relative bg-gray-50 py-4 px-4 h-full w-full"
         style={{
    ...
    >
      <div className="flex justify-between items-center mb-4 fixed top-0 left-0 px-4 py-2 w-full">
      ...
      <div id="content-div" className="overflow-auto h-full mt-12 pb-8">
        <div className="w-full flex flex-col gap-4">
          ...
          <p>Born and raised in India, I have lived in the UK since 2014 and have worn many different professional and
          ...
          <h3 className="font-semibold">Gear shift</h3>
          ...
          <h3 className="font-semibold">Lockdown</h3>
